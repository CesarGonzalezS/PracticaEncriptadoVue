<template>
    <div>
        <h1>Login</h1>
        <button @click="login('admin')">Login desde admin</button>
        <button @click="login('editor')">Login desde editor</button>
        <button @click="login('viewer')">Login desde viewer</button>
